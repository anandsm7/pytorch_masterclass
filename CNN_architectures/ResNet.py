...
Original file is located at
    https://colab.research.google.com/drive/1e9ZfUj75SheP7Yl0wAq7GIOuQTOrJeTS
"""
...
class block(nn.Module):
  def __init__(
    ...
    self.conv3 = nn.Conv2d(
        intermediate_channel,
        intermediate_channel * self.expansion,
        kernel_size=1,
        stride=1,
        padding=0,
        bias=False
    )
    self.bn3 = nn.BatchNorm2d(intermediate_channel * self.expansion)
    self.relu = nn.ReLU()
...
class ResNet(nn.Module):
  ...
  def _make_layer(self, block, num_residual_block, 
